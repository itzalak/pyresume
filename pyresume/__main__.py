...
def get_args():
    ...
    group.add_argument(
        ...
        help="Path for the css style file.",
    )
    group.add_argument(
        "-simple", action="store_true", help="Generate pdf with simple style."
    )
    group.add_argument(
        "-bar",
        action="store_true",
        help="Generate pdf with colored bar before headers.",
    )
    group.add_argument(
        "-divider",
        action="store_true",
        help="Generate pdf with colored divider between headers.",
    )
    args.add_argument(
        "-m",
        "--md",
